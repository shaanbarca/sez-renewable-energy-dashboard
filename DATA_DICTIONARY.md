...
| `delivered_cost_gap_vs_grid_pct` | float/null | V3.10: `(delivered_cost_blended_usd_mwh − grid_rate) / grid_rate × 100`. Negative = delivered cost below grid. Tenant-view counterpart to `solar_competitive_gap_pct`. |
