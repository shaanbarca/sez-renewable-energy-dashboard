        ...
        flags_panel = dmc.TabsPanel(
            html.Div(
                [
                    ...
                    _row("Invest Transmission", str(kek.get("invest_transmission", "---")), ""),
                    _row("Invest Substation", str(kek.get("invest_substation", "---")), ""),
                    _row("Invest Battery", str(kek.get("invest_battery", "---")), ""),
                    _row("Invest Resilience", str(kek.get("invest_resilience", "---")), ""),
