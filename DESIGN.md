...
| 2026-04-17 | — | **V4.0 Industrial Parks Expansion — 25 KEKs → 48 sites.** Added 23 Priority 1 industrial sites (7 steel, 10 cement, 2 aluminium, 3 fertilizer, 3 non-KEK nickel). | Indonesia's industrial CO₂ comes overwhelmingly from sites outside KEK boundaries. KEK-only screening missed the biggest point-source emitters. |
